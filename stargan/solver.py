...
class Solver(object):
    ...
    def test_attack(self):
        ...
        # Load watermark extractor.
        self.load_watermark_extractor(self.watermark_extractor_name)
        ...
        for i, (x_real, c_org) in enumerate(data_loader):
            ...
            pgd_attack = attacks.LinfPGDAttack(model=self.G, device=self.device, feat=None, watermark_extractor=self.watermark_extractor, lam=1.0, extractor_input_size=224)
            ...
            for idx, c_trg in enumerate(c_trg_list):
                ...
                result.append(extraction_output)
            ...
            if i == 2:     # stop after this many images
                break
